...
<template>
  <div class="flex flex-col gap-4">
    ...
    <p v-if="reportCount === 0" class="text-caption text-grey-300">
      아직 생성된 리포트가 없어요.<br />
      한 달간의 활동 데이터가 쌓이면<br />
      리포트가 만들어져요.
    </p>
    ...
    <template v-else>
      ...
      >
        <div class="flex items-start justify-between">
          <span
            class="rounded-full bg-grey-white px-3 py-1.5 text-[10px] font-bold text-primary-800"
          >
            최신
          </span>
