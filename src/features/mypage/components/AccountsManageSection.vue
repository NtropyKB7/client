...
import { registerAccountRows, BIRTH_DATE_DEFAULT_YEAR } from '@/features/onboarding/api'
import ConnectedAccountRow from '@/features/onboarding/components/ConnectedAccountRow.vue'
